...
```{r lookGeneral, message=F, fig.cap= "Sourced From SDG4 Global Database (Indicator 4.1.1)" }
#for future plots
...
```{r trends, fig.cap = "Sourced From SDG4 Global Database (Indicator 4.1,2)"}
